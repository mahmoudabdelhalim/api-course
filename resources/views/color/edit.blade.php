...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#"><i class="material-icons"></i> {{ __('Color') }} </a></li>
	...
	<div class="col-md-12">
		<div class="ms-panel">
			<div class="ms-panel-header d-flex justify-content-between">
				<h6>{{ __('edit') }}</h6>
				<a  href="{{route('color.index')}}" class="btn btn-danger"> {{ __('back') }}  </a>
			</div>
                      ...
                      <div class="ms-auth-container row">
                          ...
                          <div class="col-md-12">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      <input type="text" id="newTitle" name="colorid" value="{{$row->colorid}}" class="form-control"
